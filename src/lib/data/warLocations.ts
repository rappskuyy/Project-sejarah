...
export type HeroFilter = 'all' | 'cut-nyak-dhien' | 'teuku-umar'
...
export const warLocations: WarLocation[] = [
  ...
  // ═══════════════════════════════════════════
  // CUT NYAK DHIEN — Perjalanan Lengkap
  // ═══════════════════════════════════════════

  {
    id: 'cnd-lahir',
    name: 'Lampadang, Aceh Besar',
    subtitle: '~1848 · Tempat Lahir Cut nyak dhien',
    description: 'Cut nyak dhien lahir di Lampadang sekitar tahun 1848, sebagai putri Teuku Nanta Setia — uleebalang VI Mukim yang dihormati. Ia tumbuh dalam lingkungan keluarga bangsawan yang taat beragama, menerima pendidikan Islam dan adat Aceh yang kuat sejak kecil.',
    lat: 5.4833, lng: 95.4333,
    type: 'tempat-lahir', hero: 'cut-nyak-dhien',
  ...
  },
  {
    ...
    description: 'Cut nyak dhien menikah dengan Teuku Ibrahim Lamnga, putra uleebalang Lam Nga XIII. Pernikahan ini menyatukan dua keluarga bangsawan Aceh. Kehidupan rumah tangga yang harmonis ini dijalani di Lamnga, sebelum Perang Aceh pecah dan mengubah segalanya.',
    lat: 5.5700, lng: 95.5200,
    type: 'pernikahan', hero: 'cut-nyak-dhien',
  ...
  },
  {
    ...
    description: 'Teuku Ibrahim Lamnga gugur di Gle Tarum dalam pertempuran sengit melawan Belanda. Berita duka ini menghancurkan hati Cut nyak dhien, namun sekaligus membakar tekad baja dalam dirinya. Ia menolak berlindung di tempat aman dan bersumpah melanjutkan perjuangan suaminya.',
    lat: 5.5200, lng: 95.6000,
    type: 'pertempuran', hero: 'cut-nyak-dhien',
  ...
  },
  {
    ...
    description: 'Setelah masa iddah, Cut nyak dhien menerima lamaran Teuku Umar — panglima perang yang disegani seluruh Aceh. Pernikahan ini bukan sekadar ikatan cinta, tetapi juga memperkuat aliansi perjuangan. Cut nyak dhien menjadi penasehat strategis dan pemompa semangat pasukan Teuku Umar.',
  ...
  },
  {
    ...
    description: 'Bersama Teuku Umar, Cut nyak dhien menjalani kehidupan gerilya berpindah-pindah di hutan Aceh Utara. Penyakit rematik mulai menyerangnya, matanya perlahan melemah — namun ia menolak mundur. Ia merawat luka pasukan dan terus memompa semangat para pejuang.',
    lat: 4.9500, lng: 97.0833,
    type: 'strategi', hero: 'cut-nyak-dhien',
  ...
  },
  {
    ...
    description: 'Cut nyak dhien mendukung penuh manuver Teuku Umar yang berpura-pura menyerah ke Belanda demi memperoleh 800 senjata dan 25.000 peluru. Bersama Teuku Umar, ia menyaksikan senjata-senjata tersebut akhirnya digunakan untuk menyerang balik Belanda pada 1896.',
  ...
  },
  {
    ...
    description: 'Cut nyak dhien mendampingi Teuku Umar memimpin serangan di sepanjang pesisir barat Aceh. Kondisi kesehatannya semakin menurun — mata hampir buta, rematik parah — namun semangat juangnya tak pernah padam. Rakyat setempat memandangnya sebagai simbol ketangguhan Aceh.',
  ...
  },
  {
    ...
    description: 'Teuku Umar gugur pada 11 Februari 1899 akibat pengkhianatan seorang informan. Cut nyak dhien kehilangan suami keduanya, namun dengan kondisi sakit parah, ia tetap menolak menyerah. Selama 6 tahun berikutnya ia memimpin sisa pasukan bergerilya sendirian di pedalaman Aceh.',
  ...
  },
  {
    ...
    description: 'Selama 4 tahun Cut nyak dhien memimpin gerilya di pegunungan terjal Aceh Tengah. Hampir buta, berjalan pun susah karena rematik — namun ia terus memimpin. Para pejuang yang tersisa tetap setia mengikutinya karena keteguhan hatinya yang luar biasa.',
  ...
  },
  {
    ...
    description: 'Di persembunyian terakhirnya, Pang Laot — pengikut paling setia — terpaksa memberitahu lokasi Cut nyak dhien ke Belanda karena tidak sanggup melihat kondisinya yang sangat memprihatinkan. Belanda akhirnya menangkapnya dalam kondisi lemah tak berdaya, namun jiwanya tetap perkasa.',
  ...
  },
  {
    ...
    description: 'Belanda mengasingkan Cut nyak dhien ke Sumedang — ribuan kilometer dari Aceh. Namun bahkan dalam pengasingan, semangatnya tidak padam. Ia mengajar mengaji kepada warga Sumedang, menebarkan ilmu dan nilai-nilai Islam. Warga Sumedang mengenangnya dengan penuh hormat.',
    lat: -6.8500, lng: 107.9200,
    type: 'pengasingan', hero: 'cut-nyak-dhien',
  ...
  },
  {
    ...
    description: 'Cut nyak dhien wafat dengan tenang pada 6 November 1908. Ia dimakamkan di Gunung Puyuh, Sumedang. Pada 2 Mei 1964, Presiden Soekarno menganugerahinya gelar Pahlawan Nasional Indonesia. Makamnya kini menjadi situs sejarah yang dikunjungi ribuan orang setiap tahun.',
    lat: -6.8600, lng: 107.9300,
    type: 'gugur', hero: 'cut-nyak-dhien',
  ...
  },
  {
    id: 'tu-nikah-cnd',
    name: 'Aceh Besar',
    subtitle: '1880 · Menikahi Cut nyak dhien',
    description: 'Teuku Umar menikahi Cut nyak dhien, janda Teuku Ibrahim Lamnga yang gugur. Pernikahan ini mempersatukan dua kekuatan perjuangan — ketangkasan militer Teuku Umar dengan keteguhan moral Cut nyak dhien. Pasangan ini menjadi simbol perlawanan paling ikonik dalam Perang Aceh.',
    lat: 5.4700, lng: 95.4500,
  ...
  },
  {
    ...
    description: 'Pada 11 Februari 1899, Teuku Umar gugur di dekat Meulaboh setelah posisinya dikhianati informan. Ia ditembak dalam penyergapan Belanda. Meski gugur, warisan strategi gerilyanya diteruskan Cut nyak dhien. Ia diakui sebagai Pahlawan Nasional Indonesia pada tahun 1973.',
    lat: 4.1300, lng: 96.1100,
  ...
  },
  {
    ...
    description: 'Pidie (Sigli) menjadi salah satu pusat perlawanan terkuat Aceh. Ulama dan uleebalang Pidie banyak bergabung dalam perlawanan. Baik Teuku Umar maupun jaringan perjuangan Cut nyak dhien pernah berkoordinasi dengan pemimpin perlawanan di wilayah ini.',
