...
const MISSIONS: {
  ...
  { key: "biografi", icon: BookOpen, title: "Biografi Tokoh", text: "Latar keluarga, masa muda, dan perubahan hidup Cut Nyak Dien serta Teuku Umar.", to: "/cut-nyak-dien", label: "Telusuri peta Aceh" },
